...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="{{ asset('css/sudoku_style/style.css') }}">
...
<body class="flex-row">
    ...
    <div id="main__container">
        <div id="header__controls" class="flex-row">
            <span id="header__menu"><img src="{{ asset('js/sudoku_js/sudoku_images/3dots.svg') }}" id="dotMenuSpan" ></span>
            <Span id="header__header">SUDOKU</Span>
            <span id="header__submit"><span>Submit</span ></span>
        </div>
        <div id="dotMenu">
            <div id="back" class="flex-row" style="justify-content: space-evenly;"><img src="{{ asset('js/sudoku_js/sudoku_images/home.svg') }}" alt=""> Home</div>
    ...
    <script src="{{ asset('js/sudoku_js/global.js') }}"></script>
    <script src="{{ asset('js/sudoku_js/combinations.js') }}"></script>
    <script src="{{ asset('js/sudoku_js/validate.js') }}"></script>
    <script src="{{ asset('js/sudoku_js/board.js') }}"></script>
    <script src="{{ asset('js/sudoku_js/view.js') }}"></script>
    <script src="{{ asset('js/sudoku_js/digger.js') }}"></script>
    <script src="{{ asset('js/sudoku_js/userActions.js') }}"></script>
    <script src="{{ asset('js/sudoku_js/solver.js') }}"></script>
    <script src="{{ asset('js/sudoku_js/script.js') }}"></script>
</body>
